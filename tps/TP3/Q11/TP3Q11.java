...
public class TP3Q11 {
    ...
    public static void quicksort(ListaDupla lista, CelulaDupla esq, CelulaDupla dir) {
        CelulaDupla i = esq;
        CelulaDupla j = dir;
        CelulaDupla pivo = esq;
        while (i != j) {
            while (j != pivo && j != i && j.elemento.getEstadoNascimento().compareTo(pivo.elemento.getEstadoNascimento()) > 0 || j.elemento.getEstadoNascimento().compareTo(pivo.elemento.getEstadoNascimento()) == 0 && j.elemento.getNome().compareTo(pivo.elemento.getNome()) > 0) {
                j = j.ant;
                numComp++;
            }
            while (i != pivo && i != j && i.elemento.getEstadoNascimento().compareTo(pivo.elemento.getEstadoNascimento()) < 0 || i.elemento.getEstadoNascimento().compareTo(pivo.elemento.getEstadoNascimento()) == 0 && i.elemento.getNome().compareTo(pivo.elemento.getNome()) > 0) {
                i = i.prox;
                numComp++;
            }
            if (i != j) {
        ...
        if (esq != j) {
            quicksort(lista, esq, j.ant);
        }
        if (dir != j) {
            quicksort(lista, j.prox, dir);
        }
    }
